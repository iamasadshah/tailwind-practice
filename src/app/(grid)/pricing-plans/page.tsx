  ...
  return (
    <>
      ...
      >
        ...
        <div className="bg-pink-600 cursor-pointer hover:scale-110 hover:transition-transform hover:shadow-2xl hover:bg-green-600  hover:text-white shadow-xl rounded-md p-8 pr-32 md:p-2 md:px-10 lg:py-8 lg:px-20">
          <h3 className="font-bold text-2xl">Popular</h3>
          <p>Monthly Plan</p>
          <h2 className="font-bold text-4xl mt-4">$40</h2>
        </div>
        <div className="border shadow-xl rounded-md p-8 pr-32 cursor-pointer hover:scale-110 hover:transition-transform hover:bg-yellow-400 hover:text-white md:p-2 md:px-10 lg:py-8 lg:px-20">
